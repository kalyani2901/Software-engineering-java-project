...
public class CreateMusicView extends View {
	...
	public Music toMusic(){
	   Music mus = new Music();
        try{
        mus = new Music(title.getText(),genre.getText(), singer.getText(), Integer.parseInt(year.getText()), Integer.parseInt(quantity.getText()), Float.parseFloat(price.getText()));
       }
	...
	public CreateMusicView() {
        ...
        JLabel productCategory = new JLabel("CREATE NEW ITEM:MUSIC");
		...
		{
			JLabel lblTitle = new JLabel("Music title:");
		...
		{
			JLabel lblDirector = new JLabel("Singer:");
		...
		}
		{
			...
			GridBagConstraints gbc_singer = new GridBagConstraints();
			gbc_singer.insets = new Insets(0, 0, 5, 5);
			gbc_singer.fill = GridBagConstraints.HORIZONTAL;
			gbc_singer.gridx = 4;
			gbc_singer.gridy = 5;
			scrollPanel.add(singer, gbc_singer);
			singer.setColumns(20);
			singer.setText("");
		}
		...
		}
		{
			...
			gbc_save.gridy = 8;
				okButton.addActionListener(new ActionListener(){			
				       public void actionPerformed(ActionEvent e) {
                        if(toMusic()!=null && !(title.getText().trim().equals("")) && !(genre.getText().trim().equals("")) && !(singer.getText().trim().equals(""))){
                        getController().createMusicItem(title.getText(),toMusic());
