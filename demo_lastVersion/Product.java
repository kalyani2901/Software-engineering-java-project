...
/**
 * <pre>
 * This class represents a product in the store. Type of Products are: Movie, TV Series, Music and Games.
 ...
 * Properties can be used to represent various bits of data about the product, some properties are :
 * - Unit price
 * - Release Year
 *</pre>
 */
public class Product {
	...
	public void setProperty(String id, String displayName, Object value){
		...
		this.category.put(id, displayName);
	}
	
	/**
	 * <pre>
	 * Returns the value of the specified property. The Object here can be Movie, TV Series, Music and Games.
	 * </pre>
	...
	/**
	 * <pre>
	 * Returns the display name of the specified property like Movie, TV Series, Music and Games.
	 * </pre>
	 * @param id The property
	 * @return The display name of the property
	 */
	public String getPropertyCategory(String id){
	...
	public String getPropertiesAsText(){
		String out = "<html>";
		for(String key : this.props.keySet()) out += (getPropertyCategory(key) + "<br/>" + getPropertyValue(key).toString()) + "<br/>";
		out += "</html>";
		return out;
	}
